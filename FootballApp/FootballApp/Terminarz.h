...
private:
	...
	shared_ptr<array<string, 10>> datyMeczow; // daty meczów (jako string) (dzieñ i miesi¹c albo dzieñ, miesi¹c, rok) 
	shared_ptr<array<string, 10>> godzinyMeczow; // godziny meczów (jako string) 
public:
	Terminarz();
	~Terminarz();
	//gettery
